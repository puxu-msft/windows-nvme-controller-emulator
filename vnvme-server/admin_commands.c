...
// 辅助函数来获取 I/O 队列地址 (来自 vnvme_common.h)
extern void* VnvmeGetIoSQ(void* SharedMemory, UINT32 QueueIndex);
extern void* VnvmeGetIoCQ(void* SharedMemory, UINT32 QueueIndex);
